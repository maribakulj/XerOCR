...
- [~] **Différé-par-design** : `CanonicalLayout` (payload `LAYOUT`), l'assembleur `layout→ALTO/PAGE`, le lecteur `CANONICAL_DOCUMENT`, les projecteurs (couche 3). — *matérialisés à la tranche structure (T5).*
