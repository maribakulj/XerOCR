...
- [x] Parsers + writers **ALTO et PAGE** symétriques (writer PAGE = nouveau). — *preuve : `xerocr/formats/{alto,pagexml}/writer.py` ; `pytest tests/formats` vert*
...
- [x] `mypy` + `ruff` verts ; import sans effet de bord. — *preuve : `mypy -p xerocr.formats` Success ; `test_no_side_effect_imports`*
