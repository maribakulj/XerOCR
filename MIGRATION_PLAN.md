...
| **S6** surfaces UI | segmentation-UI · importeurs-UI | **T5** / **T7** (✅ débloqués) | 🔨 **en cours** : **S6.a importeur IIIF** (endpoint `POST /api/corpus/import/iiif`, CSRF, **gate mode public 403**, corpus immédiatement run-sélectionnable) ✅ ; reste form UI au design + endpoints eScriptorium/Gallica/découverte + segmentation-UI + vue Historique |
