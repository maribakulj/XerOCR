...
| 2 `formats` | ✅ **vert** ; **+`alto/layout_map`** (T5, `alto_to_layout` + `layout_to_alto` ↔ modèle neutre) | `xerocr/formats/MIGRATION_COUCHE_2.md` §DoD |
