...
| 8 `interfaces` | 🔨 **T4f** (CLI + `serve`/vitrine + **lanceur TU2.a** : `POST/GET/cancel` + CSRF + mode public faits ; reste SSE/upload/sélection moteur) | `xerocr/interfaces/ANALYSE_COUCHE_8.md` §DoD |
