...
Ce document fige l'architecture du **rapport HTML** de Cinoc après le constat
...
Cinoc le fait déjà à petite échelle — widget compare, nav clavier, scripts
...
`picarones demo` »), le synthétique n'étant que le **fallback**. Cinoc avait
