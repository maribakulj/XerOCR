# ANALYSE — Graphiques didactiques du rapport Cinoc
...
>
> Lu avant rédaction : `CLAUDE.md`, `cinoc/reports/DECISION_RAPPORT_INTERACTIF.md`
> (D-094), `cinoc/evaluation/analysis.py` (les 16 payloads + champs verbatim),
> `cinoc/reports/svg.py` (socle SVG existant), `MIGRATION_PLAN.md` (roll-up).
...
Cinoc collecte déjà beaucoup de **matière première** par payload. Aujourd'hui
