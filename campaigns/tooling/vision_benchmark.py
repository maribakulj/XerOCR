...
sys.path.insert(0, str(_REPO_ROOT / "packages" / "saknussemm" / "src"))
...
from saknussemm.core.editing import EditScript, ReplaceLine  # noqa: E402
from saknussemm.core.protocols import ProducerMetadata  # noqa: E402
from saknussemm.core.quality import RoutingPolicy  # noqa: E402
from saknussemm.core.pairing import (  # noqa: E402
    HYPHEN_CHARS,
    link_hyphen_pairs,
...
from saknussemm.formats.alto.parser import build_document_manifest  # noqa: E402
from saknussemm.producers.rules import (  # noqa: E402
    RulesProducer,
...
class OracleVisionProducer:
    ...
    async def produce(self, payload, *, options):
        from saknussemm.integrations.vision import crop_region
    ...
    planned = [
        ...
        (
            ...
            lambda: run_config(
                ...
                # saknussemm[qe] MaskedLMQEScorer and tunes the bound.
